...
export default class Stats extends Object {
  ...
  static initStats(): void {
    ...
    this.graphChoices = <HTMLSelectElement>(
      document.getElementById("chart-option")
    );
  ...
  static drawChart(param: Array<number>, color: string) {
    ...
    let prevX = 10;
    let prevY =
      this.CANVAS_HEIGHT - 10 - (param[0] / max) * (this.CANVAS_HEIGHT - 20);
