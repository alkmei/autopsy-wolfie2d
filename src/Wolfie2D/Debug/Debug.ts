...
export default class Debug {
  ...
  static drawBox(
    ...
    if (filled) {
      ...
      this.debugRenderingContext.fillRect(
        center.x - halfSize.x,
        center.y - halfSize.y,
        halfSize.x * 2,
        halfSize.y * 2,
      ...
      this.debugRenderingContext.strokeRect(
        center.x - halfSize.x,
        center.y - halfSize.y,
        halfSize.x * 2,
        halfSize.y * 2,
  ...
  static drawCircle(
    ...
    if (filled) {
      ...
      this.debugRenderingContext.arc(
        center.x,
        center.y,
        radius,
        0,
  ...
  static clearCanvas(): void {
    this.debugRenderingContext.clearRect(
      0,
      0,
      this.debugCanvasSize.x,
      this.debugCanvasSize.y,
    );
  }
