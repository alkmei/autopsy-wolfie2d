...
export default class Color {
  ...
  lighten(): Color {
    return new Color(
      MathUtils.clamp(this.r + 40, 0, 255),
      MathUtils.clamp(this.g + 40, 0, 255),
      MathUtils.clamp(this.b + 40, 0, 255),
      MathUtils.clamp(this.a + 10, 0, 255),
    );
  }
  ...
  toString(): string {
    return (
      "#" +
      MathUtils.toHex(this.r, 2) +
      MathUtils.toHex(this.g, 2) +
      MathUtils.toHex(this.b, 2)
    );
  }
