...
export default class Game {
  ...
  constructor(options?: Record<string, any>) {
    ...
    this.GAME_CANVAS = <HTMLCanvasElement>(
      document.getElementById("game-canvas")
    );
    this.DEBUG_CANVAS = <HTMLCanvasElement>(
    ...
    this.ctx = this.renderingManager.initializeCanvas(
      this.GAME_CANVAS,
      this.WIDTH,
      this.HEIGHT,
    );
    this.clearColor = new Color(
      this.gameOptions.clearColor.r,
      this.gameOptions.clearColor.g,
      this.gameOptions.clearColor.b,
    );
   ...
   */
  start(
    InitialScene: new (...args: any) => Scene,
